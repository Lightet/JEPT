...
class FourierPositionEncoding(nn.Module):
    ...
    def _position_encodings(
        ...
        :param include_positions: whether to include input_sequence positions p in returned encodings tensor.
...
if __name__ == '__main__':
    pos = positions(2, 4)
    print(pos)
    pos = positions(2, 4, shift=torch.tensor([[1], [2]]))

    fpe = FourierPositionEncoding((8, 4), 3)
    print(fpe(2).shape)
    print(fpe(2))
